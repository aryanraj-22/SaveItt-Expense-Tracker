...
const HeroSection = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-red-400 to-yellow-300 text-white py-20 px-4">
      ...
      <div className="bg-gray-100 py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="mt-4 font-bold">- Aryan Raj</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <FaQuoteLeft className="text-xl text-gray-400" />
            <p className="mt-4">
            ...
            <p className="mt-4 font-bold">- Rohan Singh</p>
          </div>
        </div>
      </div>
      {/* CTA */}
